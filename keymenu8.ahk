...
getwb(wb,num,wp)
{
  if (wb = "ep"){
    ...
    if (wp = ""){
      wbr =  %predir%wb\tb%num%\Browser\firefox --allow-remote  -new-tab
        return wbr
...
addMenu2(urls2,"g", "t" ,"%wt% https://www.tvtv.ca/on/toronto/m5t1c2/luCAN-OTAM5T1C2 ")
addMenu2(urls2,"g", "p" ,"%wt% https://www.tvpassport.com/tv-listings ")
addMenu2(urls2,"g", "n" ,"%wt% https://www.nocable.org/tv-guide/")
addMenu2(urls2,"g", "o" ,"%wt% https://www.ontvtonight.com/ca/guide/listings/TorontoNight.html")
addMenu2(urls2,"g", "c" ,"%wt% http://www.remotecentral.com/hdtv/")
...
addMenu2(urls2,"r","r","%wop1t% http://renseradio.com/")
...
addMenu2(urls2,"r","5","%wm1% https://www.cbc.ca/player/news/tv%20shows/the%20national/latest%20broadcast ")
...
addMenu2(urls1,"-","g","%pmail% https://accounts.google.com/signin/v2/identifier?service=mail&passive=true&rm=false&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&ss=1&scc=1&ltmpl=default&ltmplcache=2&emr=1&osid=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin")
...
addMenu2(urls1,"-","b","%pmail% http://box.com")
...
addMenu2(urls1,"n","5","%pnewstor% https://www.cbc.ca/player/news/tv%20shows/the%20national")
...
addMenu2(urls1,"m","y","%pmail% https://login.yahoo.com/m?.src=ym&.lang=en-US&.intl=us&.done=https%3A%2F%2Fmail.yahoo.com%2Fd")
...
addMenu2(urls1,"m","l","%pmail% https://login.live.com/login.srf?wa=wsignin1.0&rpsnv=13&ct=1564777376&rver=7.0.6737.0&wp=MBI_SSL&wreply=https%3a%2f%2foutlook.live.com%2fowa%2f%3fnlp%3d1%26RpsCsrfState%3d2defb976-9a4e-fc2c-3a19-234384fb20cb&id=292841&aadredir=1&CBCXT=out&lw=1&fl=dob%2cflname%2cwld&cobrandid=90015")
...
addMenu2(qread,"d","a","%wt% http://ciadotgov4sjwlzihbbgxnqg3xiyrg7so2r2o3lt5wz5ypk4sxyjstad.onion ")
addMenu2(qread,"j","f","%wt% https://forward.com/")
addMenu2(qread,"d","b","%wt% http://fncuwbiisyh6ak3i.onion/     ")
addMenu2(qread,"d","c","%wt% http://76qugh5bey5gum7l.onion/     ")
addMenu2(qread,"d","d","%wt% http://62gs2n5ydnyffzfy.onion/     ")
addMenu2(qread,"d","e","%wt% http://r6rfy5zlifbsiiym.onion/     ")
addMenu2(qread,"d","f","%wt% http://xfmro77i3lixucja.onion/     ")
addMenu2(qread,"d","g","%wt% http://wasabiukrxmkdgve5kynjztuovbg43uxcbcxn6y2okcrsg7gb6jdmbad.onion     ")
addMenu2(qread,"d","h","%wt% http://zerobinqmdqd236y.onion/   ")
addMenu2(qread,"d","i","%wt% http://blockchainbdgpzk.onion     ")
addMenu2(qread,"d","j","%wt% http://clgs64523yi2bkhz.onion/     ")
addMenu2(qread,"d","p","%wt% https://protonirockerxow.onion/     ")
addMenu2(qread,"d","n","%wt% http://bbcnewsv2vjtpsuy.onion/     ")
addMenu2(qread,"d","k","%wt% http://rougmnvswfsmd4dq.onion/     ")
addMenu2(qread,"d","l","%wt% http://nzh3fv6jc6jskki3.onion/     ")
addMenu2(qread,"d","m","%wt% http://archivecaslytosk.onion/     ")
addMenu2(qread,"d","o","%wt% http://secmailw453j7piv.onion/ ")
addMenu2(qread,"m","h","%wt% https://www.hollywoodreporter.com/")
addMenu2(qread,"d","q","%wt% https://www.facebookcorewwwi.onion/")
addMenu2(qread,"n","b","%wt% https://fast.bao.ac.cn ")
addMenu2(qread,"d","r","%wt% http://ulrn6sryqaifefld.onion/     ")
addMenu2(qread,"d","s","%wt% http://answerszuvs3gg2l64e6hmnryudl5zgrmwm3vh65hzszdghblddvfiqd.onion/     ")
addMenu2(qread,"d","t","%wt% http://scihub22266oqcxt.onion/     ")
addMenu2(qread,"d","u","%wt% https://p53lf57qovyuvwsc6xnrppyply3vtqm7l6pcobkmyqsiofyeznfu5uqd.onion/     ")
addMenu2(qread,"d","v","%wt% http://danschat356lctri3zavzh6fbxg2a7lo6z3etgkctzzpspewu7zdsaqd.onion/     ")
addMenu2(qread,"d","w","%wt% http://zqktlwi4fecvo6ri.onion/wiki/index.php/Main_Page")
addMenu2(qread,"c","y","%wt% https://whowhatwhy.com/")
addMenu2(qread,"c","j","%wt% https://jimstone.is/")
addMenu2(qread,"c","l","%wt% https://thelastpsychiatrist.com/")
addMenu2(qread,"c","d","%wt% http://www.drudgereport.com/")
addMenu2(qread,"c","r","%wt% https://rense.com")
addMenu2(qread,"c","b","%wt% https://benswann.com ")
addMenu2(qread,"c","i","%wt% https://imo.com")
addMenu2(qread,"c","e","%wt% https://www.earthfiles.com/")
addMenu2(qread,"c","z","%wt% https://zerohedge.com")
addMenu2(qread,"c","h","%wt% https:/Whatreallyhappened.com")
addMenu2(qread,"c","t","%wt% https://redd.it/1v8rmg ")


addMenu2(qread,"c","u","%wt% http://www.ibtimes.co.uk/")


addMenu2(qread,"c","a","%wt% http://www.abreureport.com/")


addMenu2(qread,"c","g","%wt% http://www.cryptogon.com/")
addMenu2(qread,"c","s","%wt% http://www.thetruthseeker.co.uk/")
addMenu2(qread,"x","d","%wt% http://www.disclose.tv/")
addMenu2(qread,"c","k","%wt% http://www.wanttoknow.info/")
addMenu2(qread,"c","n","%wt% http://beforeitsnews.com/")
addMenu2(qread,"x","c","%wt% http://www.cabaltimes.com/")
addMenu2(qread,"x","k","%wt% http://news.conspiracy.co/")
addMenu2(qread,"x","e","%wt% http://enenews.com/")
addMenu2(qread,"c","p","%wt% http://www.theepochtimes.com/")
addMenu2(qread,"c","v","%wt% http://www.thepeoplesvoice.org/TPV3/")
addMenu2(qread,"x","a","%wt% http://www.allgov.com/")
addMenu2(qread,"x","s","%wt% http://stratrisks.com/")
addMenu2(qread,"x","i","%wt% http://www.informationliberation.com/")
addMenu2(qread,"c","3","%wt% http://www.1913intel.com/")
addMenu2(qread,"c","i","%wt% http://intelnews.org/")
addMenu2(qread,"x","t","%wt% http://www.trueactivist.com/")
addMenu2(qread,"x","v","%wt% http://dissidentvoice.org/")
addMenu2(qread,"x","c","%wt% http://www.dailycensored.com/")
addMenu2(qread,"x","m","%wt% http://truthstreammedia.com/")
addMenu2(qread,"x","h","%wt% http://www.hangthebankers.com/")
addMenu2(qread,"x","w","%wt% http://thewatchers.adorraeli.com/")
addMenu2(qread,"x","q","%wt% http://www.damagedearth.com/")
addMenu2(qread,"x","h","%wt% http://hisz.rsoe.hu/alertmap/index2.php")
addMenu2(qread,"x","p","%wt% http://preventdisease.com/")
addMenu2(qread,"x","f","%wt% http://foodfreedomgroup.com/")
addMenu2(qread,"x","w","%wt% http://www.wired.com/category/dangerroom")
addMenu2(qread,"x","n","%wt% http://motherboard.vice.com/en_us")
addMenu2(qread,"s","a","%wt% http://www.scientificamerican.com/")
addMenu2(qread,"s","h","%wt% http://singularityhub.com/")
addMenu2(qread,"s","p","%wt% http://phys.org/")
addMenu2(qread,"s","d","%wt% http://scitechdaily.com/")
addMenu2(qread,"s","k","%wt% http://earthsky.org/space")
addMenu2(qread,"s","g","%wt% http://www.dailygalaxy.com/")
addMenu2(qread,"c","w","%wt% http://www.whale.to")
addMenu2(qread,"c","6","%wt% http://www.bibliotecapleyades.net/")
addMenu2(qread,"c","2","%wt% http://cryptome.org/")
addMenu2(qread,"c","0","%wt% http://www.paulcraigroberts.org/")
addMenu2(qread,"c","1","%wt% http://www.veteranstoday.com/")
addMenu2(qread,"c","4","%wt% http://www.veteransnewsnow.com/")
addMenu2(qread,"x","4","%wt% http://therundownlive.com/")
addMenu2(qread,"x","7","%wt% http://www.thenation.com/")
addMenu2(qread,"x","5","%wt% http://dailysignal.com/")
addMenu2(qread,"x","6","%wt% http://tarpley.net/")
addMenu2(qread,"x","3","%wt% http://electronicintifada.net/")
addMenu2(qread,"x","1","%wt% http://vigilantcitizen.com/")
addMenu2(qread,"x","2","%wt% http://www.truthcontrol.com/")
addMenu2(qread,"x","6","%wt% http://www.newdawnmagazine.com")
addMenu2(qread,"x","8","%wt% http://ultraculture.org/")
addMenu2(qread,"x","9","%wt% http://www.crowdfreedom.com/")
addMenu2(qread,"y","m","%wt% http://news.mongabay.com/")
addMenu2(qread,"y","e","%wt% http://www.theecologist.org/")
addMenu2(qread,"y","i","%wt% http://www.publicintegrity.org/")
addMenu2(qread,"y","a","%wt% http://news.antiwar.com/")
addMenu2(qread,"y","d","%wt% http://desertpeace.wordpress.com/")
addMenu2(qread,"y","j","%wt% http://www.thesleuthjournal.com/")
addMenu2(qread,"y","t","%wt% http://nontelevisedtruth.com/")
addMenu2(qread,"y","n","%wt% http://www.naturalnews.com/")
addMenu2(qread,"y","l","%wt% http://www.liveleak.com/")
addMenu2(qread,"y","b","%wt% http://www.batr.org/")
addMenu2(qread,"y","a","%wt% http://www.activistpost.com/")
addMenu2(qread,"y","d","%wt% http://adst.org/")
addMenu2(qread,"y","c","%wt% http://clouverse.com/")
addMenu2(qread,"y","f","%wt% http://www.truthdig.com/")
addMenu2(qread,"y","o","%wt% http://thinkprogress.org/")
addMenu2(qread,"y","q","%wt% http://policestatedaily.com/")
addMenu2(qread,"y","r","%wt% http://www.realcleardefense.com/")
addMenu2(qread,"y","[","%wt% http://www.globalpost.com/")
addMenu2(qread,"y","g","%wt% http://www.globalresearch.ca/")
addMenu2(qread,"y","v","%wt% http://www.voltairenet.org/spip.php?page=mot-groupe&id_groupe=19&lang=en")
addMenu2(qread,"y","k","%wt% http://topinfopost.com/")
addMenu2(qread,"y","m","%wt% http://www.paranoiamagazine.com/feed/")
addMenu2(qread,"y","z","%wt% https://conspiracypsychology.com/feed/")
addMenu2(qread,"y","w","%wt% https://static6.businessinsider.com/category/conspiracy-theory.rss")
addMenu2(qread,"q","a","%wt% http://feeds.feedburner.com/atlanteanconspiracy/VAhj")
addMenu2(qread,"q","s","%wt% https://stillnessinthestorm.com/feed")
addMenu2(qread,"q","c","%wt% https://www.conspiracy-cafe.com/apps/blog/entries/feed/rss")
addMenu2(qread,"q","9","%wt% https://911truth.org/feed/")
addMenu2(qread,"q","z","%wt% https://www.conspiracyarchive.com/feed/")
addMenu2(qread,"q","g","%wt% https://www.dailygrail.com/category/conspiranoia/feed/")
addMenu2(qread,"q","r","%wt% https://www.corbettreport.com/category/articles/feed/")
addMenu2(qread,"q","u","%wt% https://www.thesun.co.uk/topic/conspiracy-theories/feed/")
addMenu2(qread,"q","e","%wt% https://www.express.co.uk/latest/conspiracy-theory/rss")
addMenu2(qread,"q","v","%wt% https://reason.com/category/volokh/feed/atom/%3Fx%3D1")
addMenu2(qread,"q","n","%wt% https://www.conspiracies.net/")
addMenu2(qread,"q","y","%wt% https://www.youtube.com/user/AlltimeConspiracies")
addMenu2(qread,"q","f","%wt% https://www.theflatearthsociety.org/home/index.php/about-the-society")
addMenu2(qread,"q","o","%wt% https://www.reddit.com/r/actualconspiracies/")
addMenu2(qread,"q","k","%wt% https://www.reddit.com/r/conspiracy/")
addMenu2(qread,"q","x","%wt% http://www.abovetopsecret.com/")
addMenu2(qread,"q","l","%wt% https://www.godlikeproductions.com/")
addMenu2(qread,"q",";","%wt% http://www.conspiracyarchive.com/")
addMenu2(qread,"q","m","%wt% https://decryptedmatrix.com/")
addMenu2(qread,"q","h","%wt% http://www.ourhollowearth.com/ourhollo/index.html")
addMenu2(qread,"q","j","%wt% https://www.state.gov/remarks-at-the-conference-of-presidents-of-major-american-jewish-organizations-antisemitism-the-interconnected-hatred/")
addMenu2(qread,";","w","%wt% https://www.ncjw.org/news/jewish-organization-sign-on-letter-join-ruths-revolution/")
addMenu2(qread,";","i","%wt% https://www.israelnationalnews.com/news/323332")
addMenu2(qread,";","b","%wt% https://www.bostonglobe.com/2022/06/15/metro/jewish-hit-list-massachusetts-groups-promote-map-vilifying-jewish-organizations/")
addMenu2(qread,";","k","%wt% https://www.kosherdelight.com/GermanyJewishOrganizations.shtml")
addMenu2(qread,";","s","%wt% https://www.splcenter.org/fighting-hate/extremist-files/group/jewish-defense-league")
addMenu2(qread,";","f","%wt% https://jewishfed.org/how-we-help/what-we-fund/grantees")
addMenu2(qread,";","r","%wt% https://reformjudaism.org/who-we-are/organizations-reform-movement")
addMenu2(qread,";","c","%wt% https://www.commentary.org/articles/seth-mandel/alexandria-ocasio-cortez-anti-semitism-jewish-organizations/")
addMenu2(qread,";","a","%wt% https://www.bendthearc.us/")
addMenu2(qread,";","b","%wt% https://birthrightisrael.foundation/blog/how-to-prioritize-the-jewish-organizations-you-support/")
addMenu2(qread,";","q","%wt% https://www.jqyouth.org/lgbtq-jewish-orgs/")
addMenu2(qread,";","w","%wt% https://jewishwomensfed.org/Organizations.html")
addMenu2(qread,";","h","%wt% https://www.hillel.org/")
addMenu2(qread,"'","l","%wt% https://library.columbia.edu/libraries/global/jewishstudies/guides/subjects/organizations.html")
addMenu2(qread,"'","u","%wt% https://www.unitedjewish.org/contact.php")
addMenu2(qread,"'","h","%wt% http://ijso.huc.edu/SynOrg/JewishLGBT/")
addMenu2(qread,"'","t","%wt% https://www.timesofisrael.com/adl-publishes-list-of-top-10-anti-israel-groups/")
addMenu2(qread,"'","j","%wt% https://jgsny.org/searchable-databases/indexes-to-jewish-organizations/jewish-communal-register")
addMenu2(qread,"'","t","%wt% http://www.myjewishtown.com/Organizations.html")
addMenu2(qread,"'","d","%wt% https://www.jewishdallas.org/")
addMenu2(qread,"'","b","%wt% https://bbyo.org/")
addMenu2(qread,"'","h","%wt% https://www.hias.org/")
addMenu2(qread,"'","a","%wt% https://www.aipac.org/")
addMenu2(qread,"'","i","%wt% https://www.ifcj.org/")
addMenu2(qread,"'","p","%wt% https://jewishphilly.org/")
addMenu2(qread,"'","u","%wt% https://www.jewishtucson.org/community-organizations/")
addMenu2(qread,"'","g","%wt% https://gatherdc.org/resources/dc-jewish-organizations/")
addMenu2(qread,"'","o","%wt% https://ortamerica.org/")
addMenu2(qread,"'","g","%wt% https://www.guidestar.org/NonprofitDirectory.aspx?cat=8&subcat=47&p=1")
addMenu2(qread,"'","a","%wt% https://www.ajc.org/")
addMenu2(qread,"'","f","%wt% https://www.jnf.org/")
addMenu2(qread,"'","n","%wt% https://nonprofitpoint.com/jewish-charities-to-donate-t")
addMenu2(qread,"'","c","%wt% https://www.jewishcharities.org/o/")
addMenu2(qread,"'","w","%wt% https://ajws.org/")
addMenu2(qread,"'","q","%wt% https://www.ajwnews.com/jewish-organizations")
addMenu2(qread,"'","o","%wt% https://www.ou.org/")
addMenu2(qread,",","j","%wt% https://www.jdc.org")
addMenu2(qread,",","a","%wt% https://www.adl.org/")
addMenu2(qread,",","f","%wt% https://www.jfla.org/")
addMenu2(qread,",","j","%wt% https://jewishjournal.com/culture/philanthropy/73629/")
addMenu2(qread,",","u","%wt% https://www.unitedjewish.org/")
addMenu2(qread,",","d","%wt% https://www.jewishfederations.org/")
addMenu2(qread,",","v","%wt% https://www.jewishvirtuallibrary.org/american-jewish-organizations/")
addMenu2(qread,"]","w","%wt% https://www.washingtonpost.com/news/volokh-conspiracy/wp/2015/05/04/mondoweiss-is-a-hate-site")
addMenu2(qread,"]","b","%wt% https://mediabiasfactcheck.com/mondoweiss/")
addMenu2(qread,"]","c","%wt% https://canarymission.org/organization/Mondoweiss")
addMenu2(qread,"]","p","%wt% https://myparnasa.com/top-jewish-news-sites/")
addMenu2(qread,".","s","%wt% https://socaljewishnews.com/")
addMenu2(qread,".","c","%wt% https://thecjn.ca")
addMenu2(qread,".","p","%wt% https://www.jewishpress.com/news/us-news/")
addMenu2(qread,".","j","%wt% https://njjewishnews.timesofisrael.com/")
addMenu2(qread,".","w","%wt% https://www.washingtonjewishweek.com/")
addMenu2(qread,".","b","%wt% https://boulderjewishnews.org/")
addMenu2(qread,".","e","%wt% https://washtenawjewishnews.org/")
addMenu2(qread,".","l","%wt% https://www.timesofisrael.com/topic/london-jewish-news/")
addMenu2(qread,".","m","%wt% https://www.sun-sentinel.com/florida-jewish-journal/news/miami-dade/")
addMenu2(qread,".","a","%wt% https://albertajewishnews.com/")
addMenu2(qread,".","i","%wt% https://aish.com")
addMenu2(qread,"/","t","%wt% https://www.jewishtimes.com/")
addMenu2(qread,"/","j","%wt% https://jewishjournal.org/")
addMenu2(qread,"/","a","%wt% https://www.akronjewishnews.com/")
addMenu2(qread,"/","h","%wt% https://www.heritagefl.com/")
addMenu2(qread,"/","c","%wt% http://www.jewishcanton.org/sjn.html")
addMenu2(qread,"/","2","%wt% https://www.yiddish24.com/")
addMenu2(qread,"/","w","%wt% https://jweekly.com/")
addMenu2(qread,"/","b","%wt% https://www.chabad.org/news/default_cdo/jewish/News.htm")
addMenu2(qread,"/","a","%wt% https://www.atlantajewishtimes.com/")
addMenu2(qread,"/","i","%wt% https://blogs.timesofisrael.com/jewish-news/")
addMenu2(qread,"/","x","%wt% https://www.crescentcityjewishnews.com")
addMenu2(qread,"/","z","%wt% https://www.jewishexponent.com/")
addMenu2(qread,"/","u","%wt% https://www.jewishnews.co.uk/")
addMenu2(qread,"/","o","%wt% https://www.jewishaz.com/")
addMenu2(qread,"/","q","%wt% http://www.worldjewishdaily.com/")
addMenu2(qread,"1","b","%wt% https://jewishbreakingnews.com/")
addMenu2(qread,"1","j","%wt% https://en.jdn.co.il/")
addMenu2(qread,"1","i","%wt% https://www.israelnationalnews.com/section/7")
addMenu2(qread,"1","l","%wt% https://www.localjewishnews.com/")
addMenu2(qread,"1","f","%wt% https://jfedsrq.org/jewish-news")
addMenu2(qread,"1","w","%wt% https://thejewishweekly.com/")

addMenu2(qread,"1","c","%wt% https://www.clevelandjewishnews.com")
addMenu2(qread,"1","v","%wt% http://www.jewishnewsva.org/")
addMenu2(qread,"1","h","%wt% https://www.haaretz.com/jewish/")
addMenu2(qread,"1","p","%wt% https://www.jpost.com/")
addMenu2(qread,"1","a","%wt% https://www.australianjewishnews.com")
addMenu2(qread,"1","y","%wt% https://www.jta.org/category/united-states")
addMenu2(qread,"1","m","%wt% https://thejewishnews.com/")
addMenu2(qread,"1","o","%wt% https://www.jns.org//")

addMenu2(qread,"1","t","%wt% https://www.tabletmag.com/sections/news")
addMenu2(qread,"1","l","%wt% https://jewishnews.com")
addMenu2(qread,"1","k","%wt% https://mondoweiss.net/")
addMenu2(qread,"h","p","%wt% https://hpathy.com/materia-medica/")
addMenu2(qread,"c","2","%wt% https://2700chess.com/")
addMenu2(qread,"c","3","%wt% https://2700chess.com/juniors")
addMenu2(qread,"h","w","%wt% https://www.westonaprice.org/")
addMenu2(qread,"]","r","%wt% https://rense.com/")
addMenu2(qread,"]","t","%wt% https://renseradio.com/")
addMenu2(qread,"]","e","%wt% https://www.erasingtheliberty.com/")
