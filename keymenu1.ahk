...
global wtbc  := getwb("tb","4","tb4c")
global wtbmed  :=getwb("tb","1","tb1med") 

global wf :=getwb("ff","1","pwf") 
global ffwb := wf 

global wtdef :=getwb("tb","1","") 
global wtwb11r := getwb("tb","1","twb11e")
global wt := wtwb11r 
global wo0 := getwb("op","0","") 
global woc:= getwb("op","4","op4c")
global wot:=  getwb("op","1","op1t")

global woch:=  getwb("op","2","op2ch")
global wo :=  woc 
global wosf :=  wot 

global we0 :=  getwb("ep","0","")  
global woy := getwb("op","3","op3y")  
global wey := wep1y 
global wech := wep2ch
...
global wt1 := getwb("tb","1","")  
global wo1 := getwb("op","1","op1g")  
global wm1 := wm  

global wt := wt1 
global wo := wop1g  

global wf1 := getwb("ff","1","")
